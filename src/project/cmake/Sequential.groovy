            ...
            "attachments": [
                {
                    ...
                    "fields": [
                        ...
                        {
                            "title": "Changes",
                            "value":  "<https://github.com/iFeelSmart/T4D-Sample-CMake/commits/${env.BRANCH_NAME}|${env.M_GitSHA7}> ${env.M_GitCommiterEmail}",
                            "short": true
                        }
                    ],
...
def notifBuildSucceeded(){
    ...
    M_Message="""{
            "attachments": [
                {
                    "color": "#313131",
                    "author_name": "${env.M_JobName} -  <https://github.com/iFeelSmart/T4D-Sample-CMake/commits/${env.BRANCH_NAME}|${env.M_Version} - ${env.M_GitSHA7}>",
                    "author_link": "Author Link test",
                    "author_icon": "https://avatars1.githubusercontent.com/u/16338861?v=3&s=400",
